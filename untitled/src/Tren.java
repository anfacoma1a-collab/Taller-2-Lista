 ...
 *  Utilice una lista simple, porque me permite navegar de bagón a bagón revisar sue contenido, además este codigo me permite agregar y/o quitar
 *  bagones en dado caso que lo requiera, para el ejercicio es sufuciente podría ser no las rádipara pero igual me permite el desarrollo del ejercicio.
 *
 *  Estructura elegida .....:
...
public class Tren {
    ...
    public boolean desengancharVagon(String codigo) {
       ...
       ListNode iterador = tren.cabeza;

       while (iterador.siguiente !=null){

           iterador = iterador.siguiente;

           if (iterador.dato.equals(codigo)){

               return tren.remove(iterador);
           }
